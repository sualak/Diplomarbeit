...
public abstract class CourseFaker {
    ...
    public static List<Commands.CourseCreationCommand> generateCoursesCommandLevel1(int amount) {
        return generateCourseCommandOfType(amount, "LEVEL1", "LEVEL0");
    }

    public static List<Commands.CourseCreationCommand> generateCoursesCommandLevel2(int amount) {
        return generateCourseCommandOfType(amount, "LEVEL2", "LEVEL1");
    }

    public static List<Commands.CourseCreationCommand> generateCoursesCommandLevel3(int amount) {
        return generateCourseCommandOfType(amount, "LEVEL3", "LEVEL2");
    }

    public static List<Commands.CourseCreationCommand> generateCoursesCommandLevel4(int amount) {
        return generateCourseCommandOfType(amount, "LEVEL4", "LEVEL3");
    }

    public static List<Commands.CourseCreationCommand> generateCoursesCommandLevel5(int amount) {
        return generateCourseCommandOfType(amount, "LEVEL5", "LEVEL4");
    }
    ...
    public static List<Commands.CourseCreationCommand> generateCoursesCommandOfAllTypes(int amount) {
        List<Commands.CourseCreationCommand> courses = new ArrayList<>();
        courses.addAll(generateCoursesCommandLevel1(amount));
        courses.addAll(generateCoursesCommandLevel2(amount));
        courses.addAll(generateCoursesCommandLevel3(amount));
        courses.addAll(generateCoursesCommandLevel4(amount));
        courses.addAll(generateCoursesCommandLevel5(amount));
        return courses;
    }
